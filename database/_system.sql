...
INSERT INTO `models` VALUES (1,'2019-04-02 21:39:52','user','Model CP-1','Practical Case Model Domestic Environment','27\r\n27\r\n34\r\n','nmap\\\\nmap.exe -sP network\r\nnmap\\\\nmap.exe -p service host\r\nsysteminfo ','Model for detection of equipment in the network, states local ports and systeminfo.',1,0),(2,'2019-04-08 22:27:56','user','Model CP-2','Practical Case Model Domestic Environment','28\r\n42\r\n43\r\n43\r\n43\r\n43\r\n43\r\n','https://crt.sh/?q=%domain\r\nwhois.exe -v -nobanner domain\r\nnslookup domain\r\nnslookup -type=ns domain\r\nnslookup -type=soa domain\r\nnslookup -type=mx domain\r\nnslookup -type=any domain\r\n','Template for obtaining web domain information in a home environment',1,1),(3,'2019-04-23 11:18:14','user','Model CP-6','Practical Case Model Professional Environment','27\r\n','nmap\\\\nmap.exe -sP network\r\n','Model for detect hosts on network',1,0),(4,'2019-04-30 21:04:29','user','Model CP-3','Practical Case Model Domestic Environment','45\r\n45\r\n45\r\n45\r\n46\r\n','Netsh wlan show networks\r\nNetsh wlan show profiles\r\nNetsh wlan show drivers\r\nNetsh wlan show interfaces\r\nWifiInfoView.exe /stab\r\n','Model for information on wireless networks and interfaces in a home environment',1,0),(5,'2019-05-02 13:22:47','user','Model CP-4','Practical Case Model Domestic Environment','50\r\n50\r\n50\r\n50\r\n52\r\n49\r\n47\r\n','reg query HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Run\r\nreg query HKLM\\Software\\Microsoft\\Windows\\CurrentVersion\\Runonce\r\nreg query HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Run\r\nreg query HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Runonce\r\npslist.exe -nobanner\r\ntasklist /svc\r\nnetstat -ano\r\n','Model for getting information about running processes.',1,0),(6,'2019-05-26 21:12:19','user','Model CP-7','Practical Case Model Professional Environment','27\r\n','nmap\\\\nmap.exe -p service network\r\n','Identification of port/service status.',1,0);
...
-- Dump completed on 2019-05-26 22:27:34
